...
from app.models import User, Restaurant, Locality, Cuisine
import pandas as pd
import numpy as np
...
@app.route('/about')
def about():
    return render_template('about.html', title='about_1')

@app.route('/cusine')
def cuisine():
    return render_template('cusine.html', title='about_1')
